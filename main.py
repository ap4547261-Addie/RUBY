...
def main(page: ft.Page):
    ...
    def open_settings(e):
        ...
        try:
            ...
            inner_warmth = ft.Text(
                f"Warmth: {inner_data['warmth']}",
                size=12,
                color=ft.Colors.CYAN_300,
            )

            inner_tension = ft.Text(
                f"Tension: {inner_data['tension']}",
                size=12,
                color=ft.Colors.CYAN_300,
            )

            inner_irrit = ft.Text(
                f"Irritation: {inner_data['irritation']}",
                size=12,
                color=ft.Colors.CYAN_300,
            )
        ...
        try:
            ...
            recent_errors = (
                response_engine.recent_prediction_errors(
                    limit=5
                )
            )
